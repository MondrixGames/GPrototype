...
@export_range(1, 40) var max_distance: int = 10  # Fire distance
@export_range(0, 100) var damage: float = 25  # Damage per hit
@export_range(0, 10) var spread: float = 0  # Spread of each shot
@export_range(1, 20) var shot_count: int = 1  # Amount of shots
@export_range(0, 50) var knockback: float = 20  # Amount of knockback
@export_range(0, 90) var angle_knockback: int = 20  # Angle of knockback
